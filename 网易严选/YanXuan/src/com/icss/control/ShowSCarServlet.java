 ...
 */
@WebServlet("/ShowSCarServlet")
public class ShowSCarServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ShowSCarServlet() {
        super();
	...
	protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		List<GoodsAndSCar> SCList = server.findByCusId(id);
		req.setAttribute("SCList", SCList);
		req.getRequestDispatcher("wangyi/LoginFilter/shopping.jsp").forward(req, resp);
	}
