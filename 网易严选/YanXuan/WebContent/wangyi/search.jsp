	...
	<body>
		...
		<div class="headmain">
			<div class="w">
				...
				<div class="ic1"></div>
				<div class="ic2"></div>
				<input type="text" placeholder="日式水洗棉条纹四件套" />
			</div>
			<div class="navul">
				<ul class="tabnav w">
					<li>
		...
		<div class="main">
			...
			<div class="k_main">
				...
				<div class="k_clcontent" id="${searchStr }">
						<div class="k_rank">
							<dl class="k_rankdl">
								<dt>排序 :</dt>
								<dd>
						...
						<div class="k_data">
							<ul class="k_dataul clearfix">
								...
								<c:forEach items="${searchList }" var="goods">
									<li id="${goods.goodId }">
										<p class="k_daimg">
											<a><img src="${goods.goodImg }" /></a>
											<c:if test="${!(goods.goodColNum eq 1) }">
												<span>${goods.goodColNum }色可选</span>
											</c:if>
											
										</p>
										<div class="k_datext">
											<c:choose>
												<c:when test="${goods.goodIsNew eq 1 }">
													<span>新品</span>
												</c:when>
												<c:otherwise>
											...
											<h4><a>${goods.goodName }</a></h4>
											<p class="k_daprice">￥${goods.goodPrice }</p>
											<p class="k_daintr">${goods.goodDescribe }</p>
										</div>
									</li>
								</c:forEach>
